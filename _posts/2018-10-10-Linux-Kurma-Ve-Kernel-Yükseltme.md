...
<ul>
	...
	<br/>
	<br/>
	<li><strong>uname –r</strong> komutunu ile kernel sürümünü öğreniyoruz.</li>
	...
	<br/>
	<br/>
	<li><strong>cp /home/"Kullanıcı Adınız"/İndirilenler/linux-4.18.11.tar.xz /usr/src</strong> komutunu tekrar çalıştırıyoruz.</li>
